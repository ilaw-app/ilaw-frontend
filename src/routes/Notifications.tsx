  ...
  return (
    <svg width={20} height={20} viewBox="0 0 20 20" fill="none">
      <path
        ...
        stroke="#BEE966" strokeWidth={1.66609} strokeLinecap="round" strokeLinejoin="round"
      />
    </svg>
  );
}
...
function NotiIcon({ type }: { type: string }) {
  ...
  if (type === 'community_comment' || type === 'community_like') return <CommunityGlyph size={20} color="#BEE966" />;
